...
$(function () {
	...
	$(document).on('click', function (e) {
		if ($(e.target).closest('.js-menu-toggle').length || $(e.target).hasClass('menu')) {
			$body.toggleClass('overflow')
			$('.header__logo').toggleClass('is-active')
			$('.header__tools, .header__menu-btn').toggleClass('is-hidden')
	...
	// Subnav open/close
	$(document).on('click', function (e) {
		if ($(e.target).closest('.js-subnav-toggle').length) {
			$('.js-subnav-toggle').toggleClass('is-active')
		} else {
